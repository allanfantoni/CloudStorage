...
builder.Services.AddScoped<IStorageService>(options =>
{
    ...
    var applicationName = builder.Configuration.GetValue<string>("CloudStorage:ApplicationName");
    ...
    return new GoogleDriveStorageService(apiCodeFlow, applicationName);
});
